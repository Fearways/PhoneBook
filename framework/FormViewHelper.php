...
class FormViewHelper
{
    ...
    public function initBootstrapButton() : FormViewHelper
    {
        $this->_elements[$this->_currentElementId]['opening tag'] = '<span class="input-group-btn">
        <button class="btn btn-default" type="button"';
        $this->_elements[$this->_currentElementId]['closing tag'] = '</button>
      </span>';
